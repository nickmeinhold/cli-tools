...
NOTIFY_TO="you@example.com"  # change if you want alerts elsewhere
STORAGE="fb-marketplace"            # playwright session name

DIR="$HOME/git/tools/cli-tools/marketplace-watch"
SEEN="$DIR/seen.json"
LOG="$DIR/watch.log"
PW="node $HOME/git/tools/cli-tools/playwright/playwright.mjs"
GMAIL="node $HOME/git/tools/cli-tools/google/gmail.mjs"
